...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::export_memory_intel,
            commands::import_memory_intel,
            commands::export_system_settings,
            ...
            commands::request_north_star_location_pulse,
            commands::dispatch_drafted_outreach,
            commands::dispatch_next_drafted_outreach,
            commands::auto_dispatch_eligible_outreach,
            ...
            commands::get_memory_system_snapshot,
            commands::run_context_memory_pass,
            commands::seed_context_memory_example,
            ...
            commands::get_lived_moment_snapshot,
            commands::get_real_world_presence_snapshot,
            commands::list_nearby_interest_filters,
            commands::create_nearby_interest_filter,
            commands::update_nearby_interest_filter,
